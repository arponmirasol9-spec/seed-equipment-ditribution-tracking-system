const Pages = {
    ...
    showFarmerModal(farmer = null) {
        ...
        document.getElementById('modal-body').innerHTML = `
            <form id="farmer-form" class="app-form">
                <div class="grid-2">
    ...
    loadStockList(seeds, equipment) {
        ...
        (equipment || []).slice(0, 5).forEach(equip => {
        ...
        if (stockList) stockList.innerHTML = html || '<p class="text-center">No stock data available</p>';
    },
    ...
    showScheduleModal(schedule = null) {
        ...
        document.getElementById('modal-body').innerHTML = `
            <form id="schedule-form" class="app-form">
                <div class="form-group">
                    <label>Title *</label>
    ...
    async loadFarmersForModal(farm = null, isEdit = false) {
        try {
            ...
            document.getElementById('modal-body').innerHTML = `
                <form id="farm-form" class="app-form">
                    <div class="form-group">
                        <label>Farmer *</label>
                        ${farmerSelect}
